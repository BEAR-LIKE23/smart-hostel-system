  ...
  if (student === null) {
    ...
    return (
        <div className="min-h-screen bg-transparent flex items-center justify-center p-4">
            <div className="w-full max-w-lg text-center backdrop-blur-md bg-white/80 dark:bg-gray-900/80 p-8 rounded-xl shadow-md border border-red-200/50 dark:border-red-900/50">
    ...
    <div className="min-h-screen bg-transparent flex flex-col items-center justify-center p-4 transition-colors duration-300">
      <div className="w-full max-w-2xl">
        <div className="backdrop-blur-md bg-white/80 dark:bg-gray-900/80 rounded-2xl shadow-lg p-8 relative border border-gray-200/50 dark:border-gray-700/50">
            ...
            <div className="mt-8 bg-gray-50/50 dark:bg-gray-800/50 p-6 rounded-lg grid grid-cols-1 md:grid-cols-3 gap-4 text-center items-center border border-gray-200/30 dark:border-gray-750/30">
                <div>
